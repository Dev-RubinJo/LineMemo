...
class Memo: Object {
    ...
    private static func createDefaultMemo(in realm: Realm) -> Memo {
        ...
        let memo = Memo(id: id, title: "Tutorial", content: "튜토리얼입니다. 해당 어플리케이션은 메모장 어플리케이션입니다. 위 + 모양의 사각형을 눌러서 이미지를 첨부 할 수 있습니다. 또한 첨부된 이미지는 해당 이미지를 꾹 누르고 계시면 삭제를 할 수가 있고, 한번 누르면 이미지를 크게 볼 수 있습니다.", imageList: [])
